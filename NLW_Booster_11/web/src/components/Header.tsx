...
export function Header() {
  ...
  return (
    <div className='w-full max-w-3xl mx-auto flex items-center justify-between'>
      ...
      <Dialog.Root>
        <Dialog.Trigger type='button' className='border border-violet-500 font-semibold 
        rounded-lg px-6 py-4 flex items-center gap-3 hover:border-violet-300 transition-colors
